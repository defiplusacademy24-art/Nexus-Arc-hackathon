...
export function TrustedBy() {
  ...
  return (
    <section className="py-12 border-y border-orange-100 dark:border-white/5 bg-white dark:bg-[#1B1917]">
...
export function Problem() {
  ...
  return (
    <section id="problem" className="py-32 bg-[#F9EDE3] dark:bg-[#1B1917] relative">
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#E8461E]/5 blur-[120px] rounded-full pointer-events-none" />

      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="max-w-3xl mb-20">
          <h2 className="text-4xl md:text-5xl font-display font-bold text-[#1B1917] dark:text-white mb-6">
            Community Finance Still Runs on{' '}
            <span className="text-[#E8461E]">Spreadsheets and Trust</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {problems.map((prob, i) => (
            <motion.div
              ...
              className="bg-white dark:bg-white/4 border border-stone-200 dark:border-white/8 rounded-2xl p-8 group hover:border-[#E8461E]/30 dark:hover:border-[#E8461E]/30 hover:shadow-sm transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-xl bg-[#E8461E]/8 flex items-center justify-center mb-6 border border-[#E8461E]/15 group-hover:border-[#E8461E]/30 transition-colors">
                <prob.icon className="w-6 h-6 text-[#E8461E]" />
              </div>
              <h3 className="text-lg font-display font-semibold text-[#1B1917] dark:text-white mb-2">
                {prob.title}
              </h3>
